...
import * as Legacy from '../legacy/MethodDecorators.js';
import * as Modern from '../modern/MethodDecorators.js';
...
export type IModernContext<
    ...
    TThis = any
> = tLoc.IModernMethodContext<false> & {
...
export function compose(decorators: readonly ICallbackFn[]): ICallbackFn {
    ...
    iCompose.assertDecorators('CompatibleMethodDecorators.compose', decorators);
 ...
 *
 * @param opts The legacy and modern implementations of the method decorator.
 * @returns A method decorator callback that dispatches by runtime arguments.
 */
export function create(opts: ICreateOptions): ICallbackFn {
    ...
    return function(...args: any[]): any {
        ...
        throw new TypeError('Must be used as a member method decorator!');
    };
}
