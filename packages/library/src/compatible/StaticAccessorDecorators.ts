...
import * as Legacy from '../legacy/StaticAccessorDecorators.js';
import * as Modern from '../modern/StaticAccessorDecorators.js';
...
> = tLoc.IModernAccessorContext<true> & {
...
export function compose(decorators: readonly ICallbackFn[]): ICallbackFn {
    ...
    iCompose.assertDecorators('CompatibleStaticAccessorDecorators.compose', decorators);
 ...
 *
 * @param opts The legacy and modern implementations of the static accessor decorator.
 * @returns A static accessor decorator callback that dispatches by runtime arguments.
 */
