...
NodeTest.describe('[Legacy] Static Accessor Decorators', () => {

    let result: IDict<boolean> = {};

    function testGeneral(pos: string): GeneralDecorators.ICallbackFn {
        return function (...args: any[]) {
            result[pos] = StaticAccessors.validateArgs(args);
        };
    }

    function testDedicated(): StaticAccessors.ICallbackFn {
    ...
    NodeTest.it('validateArgs should reject null descriptor arguments', () => {
        ...
        NodeAssert.strictEqual(
            StaticAccessors.validateArgs([MyClass, 'value', null]),
            false,
        );
    });
    ...
    NodeTest.it('validateArgs should pass insides static accessor decorators', () => {
        ...
        class MyClass {
            ...
            @testDedicated()
            public static get a1(): string { return '123'; }
            public static set a1(v: string) { void v; }
            ...
            @testDedicated()
            public static get [symPub](): string { return '123'; }
            public static set [symPub](v: string) { void v; }
    ...
    NodeTest.it('decorators created by withArgsCheck should allows decorating static accessors', () => {

        const testDedicate = StaticAccessors.withArgsCheck(function (ctor, propName, descriptor) {
            void ctor;
            void propName;
            void descriptor;
         });
        ...
        NodeAssert.doesNotThrow(() => {
            ...
            class MyClass {
                ...
                private static _value: string = '123';

                @testDedicate
                public static get value(): string { return this._value; }
                public static set value(v: string) { this._value = v; }
            }
            void MyClass;
        });
    });

    NodeTest.it('decorators created by withArgsCheck should not allow decorating non-static-accessor elements', () => {
    ...
    NodeTest.it('decorators created by create should allows decorating static accessors', () => {

        let ctx: StaticAccessors.IContext | null = null;
        let descriptor: PropertyDescriptor | undefined;
        const testDedicate = StaticAccessors.create(function (value) {
        ...
        NodeAssert.doesNotThrow(() => {
            ...
            descriptor = Object.getOwnPropertyDescriptor(MyClass, 'value');
            void MyClass;
        });

        const actual = ctx as unknown as StaticAccessors.IContext;
        NodeAssert.ok(actual);
        NodeAssert.ok(descriptor);
        NodeAssert.strictEqual(actual.type, EContextType.STATIC_ACCESSOR);
    ...
    NodeTest.it('decorators created by create should not allow decorating non-static-accessor elements', () => {

        const testDedicate = StaticAccessors.create(function (ctx) {
