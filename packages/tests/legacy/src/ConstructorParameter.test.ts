...
NodeTest.describe('[Legacy] Constructor Parameter Decorators', () => {

    let result: IDict<boolean> = {};

    function testGeneral(pos: string): GeneralDecorators.ICallbackFn {
        return function (...args: any[]) {
            result[pos] = ConstructorParameters.validateArgs(args);
        };
    }

    function testDedicated(): ConstructorParameters.ICallbackFn {
    ...
    NodeTest.it('validateArgs should pass insides constructor parameter decorators', () => {
    ...
    NodeTest.it('decorators created by withArgsCheck should allows decorating constructor parameters', () => {

        const testDedicate = ConstructorParameters.withArgsCheck(function (
            ctor,
            _reserved,
            index
        ) {
    ...
    NodeTest.it('decorators created by withArgsCheck should not allow decorating non-constructor-parameter elements', () => {
    ...
    NodeTest.it('decorators created by create should allows decorating constructor parameters', () => {

        let ctx: ConstructorParameters.IContext | null = null;
        let ctor: any;
        const testDedicate = ConstructorParameters.create(function (value) {
        ...
        const actual = ctx as unknown as ConstructorParameters.IContext;
        NodeAssert.ok(actual);
        NodeAssert.strictEqual(actual.type, EContextType.CONSTRUCTOR_PARAMETER);
        NodeAssert.strictEqual(actual.constructor, ctor);
        NodeAssert.strictEqual(actual.parameterIndex, 0);
    });

    NodeTest.it('decorators created by create should not allow decorating non-constructor-parameter elements', () => {

        const testDedicate = ConstructorParameters.create(function (ctx) {
