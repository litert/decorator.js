...
import { EContextType, Setters, GeneralDecorators } from '@litert/decorator/legacy';
import { IDict } from '@litert/utils-ts-types';

NodeTest.describe('[Legacy] Setter Decorators', () => {

    let result: IDict<boolean> = {};

    function testGeneral(pos: string): GeneralDecorators.ICallbackFn {
        return function (...args: any[]) {
            result[pos] = Setters.validateArgs(args);
        };
    }

    function testDedicated(): Setters.ICallbackFn {
    ...
    NodeTest.it('validateArgs should reject null descriptor arguments', () => {
        ...
        NodeAssert.strictEqual(
            Setters.validateArgs([MyClass.prototype, 'value', null]),
            false,
        );
    });
    ...
    NodeTest.it('validateArgs should pass insides member setter decorators', () => {
    ...
    NodeTest.it('decorators created by withArgsCheck should allows decorating member setters', () => {

        const testDedicate = Setters.withArgsCheck(function (proto, propName, descriptor) {
            void proto;
            void propName;
            void descriptor;
         });
    ...
    NodeTest.it('decorators created by withArgsCheck should not allow decorating non-setter elements', () => {
    ...
    NodeTest.it('decorators created by create should allows decorating member setters', () => {

        let ctx: Setters.IContext | null = null;
        let descriptor: PropertyDescriptor | undefined;
        const testDedicate = Setters.create(function (value) {
        ...
        const actual = ctx as unknown as Setters.IContext;
        NodeAssert.ok(actual);
        NodeAssert.ok(descriptor);
        NodeAssert.strictEqual(actual.type, EContextType.SETTER);
    ...
    NodeTest.it('decorators created by create should not allow decorating non-setter elements', () => {

        const testDedicate = Setters.create(function (ctx) {
