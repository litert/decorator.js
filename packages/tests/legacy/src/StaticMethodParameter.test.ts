...
NodeTest.describe('[Legacy] Static Method Parameter Decorators', () => {

    let result: IDict<boolean> = {};

    function testGeneral(pos: string): GeneralDecorators.ICallbackFn {
        return function (...args: any[]) {
            result[pos] = StaticMethodParameters.validateArgs(args);
        };
    }

    function testDedicated(): StaticMethodParameters.ICallbackFn {
    ...
    NodeTest.it('validateArgs should pass insides static method parameter decorators', () => {
    ...
    NodeTest.it('decorators created by withArgsCheck should allows decorating static method parameters', () => {

        const testDedicate = StaticMethodParameters.withArgsCheck(function (m, ctx) {
            void m;
            void ctx;
         });
    ...
    NodeTest.it('decorators created by withArgsCheck should not allow decorating non-static-method-parameter elements', () => {
    ...
    NodeTest.it('decorators created by create should allows decorating static method parameters', () => {

        let ctx: StaticMethodParameters.IContext | null = null;
        let ctor: any;
        const testDedicate = StaticMethodParameters.create(function (value) {
        ...
        const actual = ctx as unknown as StaticMethodParameters.IContext;
        NodeAssert.ok(actual);
        NodeAssert.strictEqual(actual.type, EContextType.STATIC_METHOD_PARAMETER);
    ...
    NodeTest.it('decorators created by create should not allow decorating non-static-method-parameter elements', () => {

        const testDedicate = StaticMethodParameters.create(function (ctx) {
