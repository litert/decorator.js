...
NodeTest.describe('[Legacy] Method Parameter Decorators', () => {

    let result: IDict<boolean> = {};

    function testGeneral(pos: string): GeneralDecorators.ICallbackFn {
        return function (...args: any[]) {
            result[pos] = MethodParameters.validateArgs(args);
        };
    }

    function testDedicated(): MethodParameters.ICallbackFn {
    ...
    NodeTest.it('validateArgs should not pass insides member method decorators', () => {
        ...
        class MyClass {
            ...
            public [symPublicMemberMethod](): void {
                this[symPrivateMemberMethod]();
            }
    ...
    NodeTest.it('validateArgs should pass insides member method parameter decorators', () => {
    ...
    NodeTest.it('decorators created by withArgsCheck should allows decorating method parameters', () => {

        const testDedicate = MethodParameters.withArgsCheck(function (m, ctx) {
            void m;
            void ctx;
         });
    ...
    NodeTest.it('decorators created by withArgsCheck should not allow decorating non-method-parameter elements', () => {
    ...
    NodeTest.it('decorators created by create should allows decorating method parameters', () => {

        let ctx: MethodParameters.IContext | null = null;
        let proto: any;
        const testDedicate = MethodParameters.create(function (value) {
        ...
        const actual = ctx as unknown as MethodParameters.IContext;
        NodeAssert.ok(actual);
        NodeAssert.strictEqual(actual.type, EContextType.METHOD_PARAMETER);
        NodeAssert.strictEqual(actual.constructor, proto.constructor);
        NodeAssert.strictEqual(actual.prototype, proto);
        NodeAssert.strictEqual(actual.methodName, 'method');
        NodeAssert.strictEqual(actual.parameterIndex, 0);
    });

    NodeTest.it('decorators created by create should not allow decorating non-method-parameter elements', () => {

        const testDedicate = MethodParameters.create(function (ctx) {
