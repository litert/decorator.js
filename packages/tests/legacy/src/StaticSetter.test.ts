...
NodeTest.describe('[Legacy] Static Setter Decorators', () => {

    let result: IDict<boolean> = {};

    function testGeneral(pos: string): GeneralDecorators.ICallbackFn {
        return function (...args: any[]) {
            result[pos] = StaticSetters.validateArgs(args);
        };
    }

    function testDedicated(): StaticSetters.ICallbackFn {
    ...
    NodeTest.it('validateArgs should reject null descriptor arguments', () => {
        ...
        NodeAssert.strictEqual(
            StaticSetters.validateArgs([MyClass, 'value', null]),
            false,
        );
    });
    ...
    NodeTest.it('validateArgs should pass insides static setter decorators', () => {
    ...
    NodeTest.it('decorators created by withArgsCheck should allows decorating static setters', () => {

        const testDedicate = StaticSetters.withArgsCheck(function (ctor, propName, descriptor) {
            void ctor;
            void propName;
            void descriptor;
         });
        ...
        NodeAssert.doesNotThrow(() => {
            ...
            class MyClass {
                ...
                @testDedicate
                public static set value(v: string) { void v; }
            }
            void MyClass;
        });
    });

    NodeTest.it('decorators created by withArgsCheck should not allow decorating non-static-setter elements', () => {
    ...
    NodeTest.it('decorators created by create should allows decorating static setters', () => {

        let ctx: StaticSetters.IContext | null = null;
        let descriptor: PropertyDescriptor | undefined;
        const testDedicate = StaticSetters.create(function (value) {
        ...
        const actual = ctx as unknown as StaticSetters.IContext;
        NodeAssert.ok(actual);
        NodeAssert.ok(descriptor);
        NodeAssert.strictEqual(actual.type, EContextType.STATIC_SETTER);
        NodeAssert.strictEqual(actual.setterName, 'value');
        NodeAssert.strictEqual(actual.descriptor.set, descriptor.set);
    });

    NodeTest.it('decorators created by create should not allow decorating non-static-setter elements', () => {

        const testDedicate = StaticSetters.create(function (ctx) {
