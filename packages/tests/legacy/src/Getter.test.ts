...
import { EContextType, Getters, GeneralDecorators } from '@litert/decorator/legacy';
import { IDict } from '@litert/utils-ts-types';

NodeTest.describe('[Legacy] Getter Decorators', () => {

    let result: IDict<boolean> = {};

    function testGeneral(pos: string): GeneralDecorators.ICallbackFn {
        return function (...args: any[]) {
            result[pos] = Getters.validateArgs(args);
        };
    }

    function testDedicated(): Getters.ICallbackFn {
    ...
    NodeTest.it('validateArgs should reject null descriptor arguments', () => {
        ...
        NodeAssert.strictEqual(
            Getters.validateArgs([MyClass.prototype, 'value', null]),
            false,
        );
    });
    ...
    NodeTest.it('validateArgs should pass insides member getter decorators', () => {
    ...
    NodeTest.it('decorators created by withArgsCheck should allows decorating member getters', () => {

        const testDedicate = Getters.withArgsCheck(function (proto, propName, descriptor) {
            void proto;
            void propName;
            void descriptor;
         });
    ...
    NodeTest.it('decorators created by withArgsCheck should not allow decorating non-getter elements', () => {
    ...
    NodeTest.it('decorators created by create should allows decorating member getters', () => {

        let ctx: Getters.IContext | null = null;
        let descriptor: PropertyDescriptor | undefined;
        const testDedicate = Getters.create(function (value) {
        ...
        const actual = ctx as unknown as Getters.IContext;
        NodeAssert.ok(actual);
        NodeAssert.ok(descriptor);
        NodeAssert.strictEqual(actual.type, EContextType.GETTER);
    ...
    NodeTest.it('decorators created by create should not allow decorating non-getter elements', () => {

        const testDedicate = Getters.create(function (ctx) {
