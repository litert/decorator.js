...
import { StaticSetters, GeneralDecorators } from '@litert/decorator';
import { IDict } from '@litert/utils-ts-types';

NodeTest.describe('[Modern] Static Setter Decorators', () => {
    ...
    NodeTest.it('decorators created by withArgsCheck should allow decorating static setters', () => {

        const testDedicate = StaticSetters.withArgsCheck(function (target, ctx) {
            void target;
            void ctx;
        });
