...
import { Accessors, GeneralDecorators } from '@litert/decorator';
import { IDict } from '@litert/utils-ts-types';

NodeTest.describe('[Modern] Accessor Decorators', () => {
    ...
    NodeTest.it('decorators created by withArgsCheck should allow decorating member accessors', () => {

        const testDedicate = Accessors.withArgsCheck(function (target, ctx) {
            void target;
            void ctx;
        });
        ...
        NodeAssert.doesNotThrow(() => {
            ...
            class MyClass {
                ...
                @testDedicate
                public accessor value: string = '123';
            }
            void MyClass;
        });
    });
