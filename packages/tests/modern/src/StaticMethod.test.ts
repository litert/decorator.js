...
import { StaticMethods, GeneralDecorators } from '@litert/decorator';
import { IDict } from '@litert/utils-ts-types';

NodeTest.describe('[Modern] Static Method Decorators', () => {
    ...
    NodeTest.it('decorators created by withArgsCheck should allow decorating static methods', () => {

        const testDedicate = StaticMethods.withArgsCheck(function (target, ctx) {
            void target;
            void ctx;
        });
