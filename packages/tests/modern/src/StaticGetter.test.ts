...
import { StaticGetters, GeneralDecorators } from '@litert/decorator';
import { IDict } from '@litert/utils-ts-types';

NodeTest.describe('[Modern] Static Getter Decorators', () => {
    ...
    NodeTest.it('decorators created by withArgsCheck should allow decorating static getters', () => {

        const testDedicate = StaticGetters.withArgsCheck(function (target, ctx) {
            void target;
            void ctx;
        });
