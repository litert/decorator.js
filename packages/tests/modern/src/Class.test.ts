...
import { Classes, GeneralDecorators } from '@litert/decorator';
import { IDict } from '@litert/utils-ts-types';

NodeTest.describe('[Modern] Class Decorators', () => {
    ...
    NodeTest.it('decorators created by withArgsCheck should allows decorating classes', () => {
        ...
        const testDedicate = Classes.withArgsCheck(function (m, ctx) { 
            void m;
            void ctx;
         });
