...
import { Getters, GeneralDecorators } from '@litert/decorator';
import { IDict } from '@litert/utils-ts-types';

NodeTest.describe('[Modern] Getter Decorators', () => {
    ...
    NodeTest.it('decorators created by withArgsCheck should allow decorating member getters', () => {

        const testDedicate = Getters.withArgsCheck(function (target, ctx) {
            void target;
            void ctx;
        });
