...
import { StaticAccessors, GeneralDecorators } from '@litert/decorator';
import { IDict } from '@litert/utils-ts-types';

NodeTest.describe('[Modern] Static Accessor Decorators', () => {
    ...
    NodeTest.it('decorators created by withArgsCheck should allow decorating static accessors', () => {

        const testDedicate = StaticAccessors.withArgsCheck(function (target, ctx) {
            void target;
            void ctx;
        });
        ...
        NodeAssert.doesNotThrow(() => {
            ...
            class MyClass {
                ...
                @testDedicate
                public static accessor value: string;
            }
            void MyClass;
        });
    });
