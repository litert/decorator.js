...
import { Setters, GeneralDecorators } from '@litert/decorator';
import { IDict } from '@litert/utils-ts-types';

NodeTest.describe('[Modern] Setter Decorators', () => {
    ...
    NodeTest.it('decorators created by withArgsCheck should allow decorating member setters', () => {

        const testDedicate = Setters.withArgsCheck(function (target, ctx) {
            void target;
            void ctx;
        });
