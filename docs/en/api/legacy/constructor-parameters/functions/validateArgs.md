...
Source: [`packages/library/src/legacy/ConstructorParameterDecorators.ts#L160`](../../../../../../packages/library/src/legacy/ConstructorParameterDecorators.ts#L160)
...
Access this function as `ConstructorParameters.validateArgs()`.
...
function decorator(...args: any[]): void {
    if (!ConstructorParameters.validateArgs(args)) {
        throw new TypeError('Invalid decorator usage.');
    }

    // Arguments are now narrowed to ConstructorParameters.ICallbackFn parameters.
}
```
